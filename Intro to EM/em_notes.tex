...
\usepackage{amsmath, amssymb, mathtools, tikz, hyperref, float, caption, graphicx, enumitem, subcaption}
\usetikzlibrary{3d}
...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\filldraw[color=black, fill=gray!50] (0,0) circle (2);
		\draw[->] (0,0) -- (1.73, 1);
		\node[anchor=north west] at (0.866, 0.5) {$R$};
		\node[anchor=center] at (-0.7, -0.7) {$q$};
	\end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\draw[shade, black] (0,0) circle (2);
		\shade[shading=radial, outer color=gray!80, inner color=gray!10] (0,0) circle (2);
		\draw[<-] (-1.414, -1.414) -- (-4,-0.5) node[anchor=south] {$V$ on the surface};
		\node[anchor=center] at (0,0) {$V$ to be found};
	\end{tikzpicture}
\end{figure}
...
\begin{figure}[H]
	\begin{tikzpicture}
		...
		\node[anchor=south, color=gray] at (0,3) {$\vec{E}$};
		\draw[->] (-1.414, -1.414) -- (1.414, 1.414);
		\node[anchor=south east] at (0,0) {$\vec{p}$};
		\node[anchor=north west] at (0,0) {$d$};
		\filldraw[black] (-1.414, -1.414) circle (0.05) node[anchor=north] {$-q$};
		\filldraw[black] (1.414, 1.414) circle (0.05) node[anchor=south] {$+q$};
		\draw[->, color=gray] (-1.414, -1.414) -- (-2, -1.414) node[anchor=north] {$\vec{F_{-}}$};
		\draw[->, color=gray] (1.414, 1.414) -- (2, 1.414) node[anchor=south] {$\vec{F_{+}}$};
	\end{tikzpicture}
\end{figure}
...
%complete the remaining stuff of polarization.
...
\begin{figure}[H]
	%\centering
	\begin{tikzpicture}
		\filldraw[color=black, fill=gray] (-0.5,-4) -- (-0.5, 4) arc (90:270:4) -- cycle;
		\filldraw[color=black, fill=gray] (0.5,4) -- (0.5, -4) arc (-90:90:4) -- cycle;
		\node[anchor=center] at (4,4) {$B \otimes$};
		\node[anchor=center] at (0, 4.5) {$\sim E$};
		\draw[->] (0,0) -- (-0.5, 0);
		\draw[->] (-0.5,0) arc (90:270:0.5);,-0.5
		\draw[->] (-0.5,-1) -- (0.5, -1);
		\draw[->] (0.5, -1) arc (-90:90:1);
		\draw[->] (0.5,1) -- (-0.5, 1);
		\draw[->] (-0.5, 1) arc (90:270:2);
		\draw[->] (-0.5,-3) -- (0.5, -3);
		\draw[->] (0.5, -3) arc (-90:90:3);
		\draw[->] (0.5,3) -- (-5, 3) node[anchor=south] {beam of} node[anchor=north] {charged particles};
