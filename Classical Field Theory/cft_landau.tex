...
Thus, in the new frame, the two events occur at the same time, and the distance between them is:
\[l_{12}' = \sqrt{l_{12}^2 - c^2 t_{12}^2} = is_{12}\]

Due to the invarient nature of \(s_{12}\), the time and space-like character of an interval is independent of the refernce frame.
