...
\begin{itemize}
    ...
    Eg: \[\begin{bmatrix}
        ...
        0 & 0 & 0 & \vline & 0 
        \end{bmatrix}\]
        This has no solution as the 3rd row is $0 = 1$ which is not possible.
...
\subsection{Distribution Vector and Transformation Matrix}
a vector $x$ in $\mathbb{R}^n$ is a distribution vector if its components are non-negative and sum to 1.\\
A matrix $A$ is a transformation matrix if its columns are distribution vectors.
