...
\begin{itemize}
    ...
    \item The reference point $O$ is arbitrary and changing it will only add a constant $k$ to the potential. While Subtracting, the will get cancelled out.
...
\begin{itemize}
    \item \textbf{E=0 inside the conductor} If there was an electric field, the charges (electrons) inside the conductor would move such that there is a positive charge on one part of the conductor and negative charge on the other side of the conductor. This would create an electric field opposite to that of the external field and we would get no net field in the bulk of the conductor
        \begin{tikzpicture}
