...
Consider a linear Charge distribution, $\lambda$ of length $l$, along the $x$ axis. The electric field at $\vec{R}$ is given by: 
...
\[E = \int_{\text{length $l$}} \frac{1}{4\pi \epsilon_0} \frac{\lambda dx}{r^2} \hat{r} \]
