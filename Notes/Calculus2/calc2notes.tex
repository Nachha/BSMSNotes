...
\\
Eg: \[ \lim_{(x,(x,y)\rightarrow (0,0))} \frac{x^2 - xy}{\sqrt{x} - \sqrt{y}}\]
\[ \lim_{(x,(x,y)\rightarrow (0,0))} \frac{x(x-y)}{\sqrt{x} - \sqrt{y}}\]
\[ \lim_{(x,(x,y)\rightarrow (0,0))} x(\sqrt{x} + \sqrt{y})\]
\[ \therefore \lim_{(x,(x,y)\rightarrow (0,0))} \frac{x^2 - xy}{\sqrt{x} - \sqrt{y}} = 0 \]
\\
Eg: \[ \lim_{(x,(x,y)\rightarrow (0,0))} \frac{2x^2y}{x^4 + y^2}\]
